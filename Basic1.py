...
# d=int(3*(a+b+c))
# if a==b==c:
#     print("three times the no sum:",d)
# else:
#     print(a+b+c)

# #program that returns a string that is n (non-negative integer) copies of a given string.
# def large_string (test,n):
#    result = " "
#    for i in range(n):
#     result = result+ test
#    return result
# print(large_string('abs',6))
# print(large_string('.py',2))
...
#          count=count+1
#     return count
# print(count_num_4([4,5,4,7,4,8,9]))
# print(count_num_4([4,5,4,4,4,4,4,5]))
